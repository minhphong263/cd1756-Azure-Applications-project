...
class Config(object):
    ...
    SQL_DATABASE = os.environ.get('SQL_DATABASE') or 'phongvm'
    SQL_USER_NAME = os.environ.get('SQL_USER_NAME') or 'phongvm'
    ...
    CLIENT_SECRET = "Tpf8Q~3j.o7QaQWtQurwdHVXWPNAN_3kTHA1wclx"
    ...
    CLIENT_ID = "1f1cf873-d808-4e7b-b769-bce026b0b9f7"
